...
// import { playBonk, playWin, playCross } from "./sounds.js";
import { playCross, playBonk, playStart, startSong, stopSong } from './sounds.js';
...
sceneOne.onUpdate = () => {
  ...
  // const prevX = wizardPos.x;
  // const prevY = wizardPos.y;
  ...
  // If clamped, play bonk—but throttle to once per 1 second
  // const now = performance.now();
  // if ((wizardPos.x !== prevX || wizardPos.y !== prevY) && now - lastBonkTime > 1000) {
  //   playBonk();
  //   lastBonkTime = now;
  // }
...
titleScene.buttonConfig = {
  ...
  width: 120,
  height: 50,
  onClick: () => {playStart(); startSong(); sceneManager.changeScene(sceneOne)},
  color: "green"
};
